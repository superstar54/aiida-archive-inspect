    ...
    with SandboxFolder(filepath=filepath) as temp_folder:
        ...
        if web_based:
            ...
            try:
                ...
                print("downloading archive failed", exception)
        ...
        try:
            ...
            if try_migration:
                print("    incompatible version detected for, trying migration")
                try:
                ...
                try:
                    ...
                    print(
                        "    an exception occurred while trying to import the migrated archive",
                        sub_exception,
                    )
            else:
                print(
                    "    an exception occurred while trying to import the archive",
                    exception,
                )
        except Exception as exception:
            print(
        ...
        print("Imported archive successfully!")
        return group_id
...
def generate_table(group):
    ...
    table_html = f"<h2>Overview of the archive file</h2><div></div><table>{table_style}<tr><th>Key</th><th>Value</th></tr>"
